<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EczaciGiris.aspx.cs" Inherits="HospitalSystemWebApp.Eczacilar.EczaciGiris" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Eczacı-Giriş</title>
    <link href="EczaciGirisCss.css" rel="stylesheet" />
</head>
<body>
    <form id="form1" runat="server">
            ...
            <div class="satir">
                <br />
                <br />
                <h1 style="color: red">Eczacı Giriş</h1>
            </div>
            <div class="satir">
