<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EczaciGiris.aspx.cs" Inherits="HospitalSystemWebApp.EczaciPaneli.EczaciGiris" %>
    ...
    <form id="form1" runat="server">
        <div class="tasiyici">
            <div class="satir">
                <br />
                <br />
                <h1 style="color: mediumpurple">Eczacı Giriş</h1>
            </div>
            <div class="satir">
